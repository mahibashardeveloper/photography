...
Route::group(
    ...
    function () {
        ...
        Route::post('/update', [UserController::class, 'user_profile_update'])->name('User.Profile.update');
        Route::post('/password', [UserController::class, 'user_password_update'])->name('User.Profile.Password');
