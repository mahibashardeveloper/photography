<template>
    ...
    <div class="p-2">
        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-3 p-1">
            <div class="p-3 border border-secondary-subtle position-relative" v-for="each in image">
                ...
                <div class="position-absolute top-0 end-0 p-2">
                    <div class="dropdown">
                        <button class="btn btn-outline-secondary py-1 px-1" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-three-dots-vertical"></i>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item mb-1" href="javascript:void(0)"  data-bs-toggle="modal" data-bs-target="#editModal">
                                    Edit
                                </a>
                            </li>
                            <li>
    ...
    <div class="modal fade" id="deleteModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-3">
                <div class="modal-body">
                    <div class="h3 pt-5 text-center">Are you Sure?</div>
                </div>
